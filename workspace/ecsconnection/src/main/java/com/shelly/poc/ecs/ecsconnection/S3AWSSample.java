...
public class S3AWSSample {
    ...
    public static void main(String[] args) throws IOException {
       ...
       /* AmazonS3 s3 = new AmazonS3Client();
        ...
        String bucketName = "mybucketno3aug2018" ;//+ UUID.randomUUID();
        ...
        try {
             ...
             * Show the list of Objects in the bucket
             */
          ...
          //  s3.putObject(new PutObjectRequest(bucketName, key, createSampleFile()));
            ...
            s3.putObject(bucketName, fileObjKeyName, createSampleFile());
            

            // Copy the object into a new object in the same bucket.
            CopyObjectRequest copyObjRequest = new CopyObjectRequest(bucketName, fileObjKeyName, bucketName, "destinationKey");
            ...
            object = s3.getObject(new GetObjectRequest(bucketName, "destinationKey"));
            System.out.println("Content-Type: "  + object.getObjectMetadata().getContentType());
            displayTextInputStream(object.getObjectContent());
    ...
    private static File createSampleFile() throws IOException {
        ...
        writer.write("!@#$%^&*()-=[]{};':',.<>/?\n");
        writer.write("01234567890112345678901234911\n");
        writer.write("abcdefghijklmnopqrstuvwxyzshelly\n");
        writer.close();
